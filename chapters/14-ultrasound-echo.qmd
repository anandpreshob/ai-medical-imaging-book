...
![Probe position and acoustic window directly shape the resulting ultrasound image.](../figures/ch14/acquisition.png){#fig-us-acquisition fig-alt="A sonographer acquires an apical cardiac view while the monitor displays a four-chamber echocardiogram and an inset shows probe orientation."}
...
![Ejection fraction is derived from traced ventricular volumes at end diastole and end systole.](../figures/ch14/ef.png){#fig-echo-ef fig-alt="Matched echocardiographic frames show end-diastolic and end-systolic left-ventricular contours with illustrative volumes and ejection fraction."}
...
![Quality assessment distinguishes a missing view, an inadequate foreshortened view, and an adequate four-chamber view ready for measurement.](../figures/ch14/quality.png){#fig-us-quality fig-alt="Three echocardiographic panels show missing anatomy, an inadequate foreshortened cardiac view, and an adequate apical four-chamber view."}
...
![Live ultrasound guidance must remain current while accepted clips and measurements enter a separate reviewed record.](../figures/ch14/live-loop.png){#fig-us-live fig-alt="A clinician scans a patient while a monitor displays a live cardiac ultrasound, view-quality guidance, and a separate accepted clip."}
