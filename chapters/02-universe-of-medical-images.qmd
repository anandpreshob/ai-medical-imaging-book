...
![Colonoscopy view of a colonic polyp. Image: Stephen Holland, M.D. ([CC BY 2.5](https://creativecommons.org/licenses/by/2.5/)).](../figures/ch02/endo-example.png){#fig-endo-ex fig-alt="Colonoscopy image showing a smooth polyp projecting from the colonic mucosa."}
:::
