...
![A conventional four-view examination preserves breast laterality and view identity.](../figures/ch15/views.svg){#fig-mammo-views fig-alt="Four labeled view slots: right CC, left CC, right MLO, and left MLO; each remains linked to its examination and laterality."}
...
![DBT reconstructs depth planes from a limited-angle acquisition; its planes are not independent examinations.](../figures/ch15/dbt.svg){#fig-mammo-dbt fig-alt="A limited-angle projection set produces a correlated DBT stack and, optionally, a synthesized two-dimensional image."}
...
![Detection and future-risk models answer different questions despite using related images.](../figures/ch15/tasks.svg){#fig-mammo-tasks fig-alt="Current-lesion detection is linked to the present examination; future-risk prediction is linked to an explicitly defined follow-up horizon."}
...
![A screening workflow separates quality review, interpretation, and diagnostic follow-up.](../figures/ch15/workflow.svg){#fig-mammo-workflow fig-alt="Acquisition quality and eligible image assembly precede AI assistance and reader assessment; follow-up and outcome ascertainment close the evaluation loop."}
