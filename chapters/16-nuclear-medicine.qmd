...
![A PET examination connects radiopharmaceutical administration, event acquisition, corrections, and reconstruction.](../figures/ch16/acquisition.svg){#fig-pet-acquisition fig-alt="Administration and timing lead to coincidence measurements, correction and reconstruction, and a quantitative image with documented units."}
...
![Quantitative uptake requires aligned units and timing, not just pixel values.](../figures/ch16/suv.svg){#fig-pet-suv fig-alt="Activity concentration, administered activity and decay reference, body-mass normalization, and unit checks combine into a documented SUV convention."}
...
![Partial-volume effects can make a small hot structure appear less intense and less sharply bounded.](../figures/ch16/partial-volume.svg){#fig-pet-partial fig-alt="A conceptual narrow source profile becomes broader and lower after limited-resolution imaging; the curves are illustrative, not patient measurements."}
...
![Longitudinal PET comparison requires compatible acquisition and a reviewed lesion inventory.](../figures/ch16/comparison.svg){#fig-pet-comparison fig-alt="Two visits undergo tracer, timing, reconstruction, and registration checks before lesion matching and a clinically interpreted change estimate."}
