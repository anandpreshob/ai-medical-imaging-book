...
![The same numerical CT signal can be displayed through different windows. These views show the same slice in lung, soft-tissue, and bone windows.](../figures/ch12/windows.png){#fig-ct-windows fig-alt="The same axial chest CT slice displayed with lung, soft-tissue, and bone windows."}
...
![Thick source slices produce stair-step multiplanar anatomy; isotropic resampling changes the grid while preserving physical locations.](../figures/ch12/geometry.png){#fig-ct-geometry fig-alt="Matched coronal CT images compare thick anisotropic source slices with a smoother isotropically resampled grid."}
...
![CT routing depends on series eligibility: noncontrast head CT, angiographic CT, and portal-venous abdominal CT are visibly different inputs for different tasks.](../figures/ch12/routing.png){#fig-ct-routing fig-alt="Three clinical CT examples show a noncontrast head CT, chest CT angiogram, and portal-venous abdominal CT."}
...
![Lesion identity persists across visits only when supported by evidence. The comparison keeps matched, new, and uncertain pulmonary findings distinct.](../figures/ch12/longitudinal.png){#fig-ct-longitudinal fig-alt="Baseline and follow-up lung CT images show a matched nodule, a new nodule, and an uncertain focus with restrained colored circles."}
