...
![Fundus photography, OCT, and OCT angiography represent different views of ocular structure and vasculature.](../figures/ch17/modalities.svg){#fig-eye-modalities fig-alt="Three panels distinguish a surface fundus view, an OCT depth section, and a derived vascular map; these are conceptual illustrations, not clinical scans."}
...
![A screening pathway treats ungradable images as a separate outcome requiring action.](../figures/ch17/quality.svg){#fig-eye-quality fig-alt="Image acquisition leads to quality assessment; adequate images proceed to a supported screening model, while inadequate images lead to reacquisition or a defined referral pathway."}
...
![The data hierarchy keeps both eyes and every visit linked to the same patient.](../figures/ch17/grouping.svg){#fig-eye-grouping fig-alt="Patient identity contains visits, each containing right and left eyes with fields or OCT volumes; split assignment is made at the patient level."}
...
![The patient pathway continues beyond an AI result to communication and completed follow-up.](../figures/ch17/referral.svg){#fig-eye-referral fig-alt="A valid screening result enters patient communication and appropriate follow-up, with completion and unresolved cases tracked separately."}
